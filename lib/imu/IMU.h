...
private:
	...
	void update_madgwick(float ax, float ay, float az, float gx, float gy, float gz);
	void update_mahony(float ax, float ay, float az, float gx, float gy, float gz);
	void update_fusion();
